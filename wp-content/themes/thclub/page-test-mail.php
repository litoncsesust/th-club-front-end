																											...
																											<td style="">
																												<table border="0" cellpadding="0" cellspacing="0" width="100%">
																													<tbody>
																														<tr>
																															<td class="padding-all" align="left" width="510" style="padding: 20px;">
																																<img border="0" alt="' . $sp['title']. '" class="img-max" height="300" src="http://test.bordingvista.com/api.th-club.com/' . $sp['files'][0]['file_path'] . '" style="display: block;color: #666666; text-decoration: none; width: auto !important;height:300px !important;padding-bottom:10px;">
																																<h2>' . $sp['title'] . '</h2>
