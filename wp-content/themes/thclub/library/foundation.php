...
if ( ! function_exists( 'fiftytwo_get_the_comments_pagination' ) ) :
	function fiftytwo_get_the_comments_pagination( $args = array() ) {
		$navigation = '';
		$args = wp_parse_args( $args, array(
			'prev_text'				=> __( '&laquo;', 'fiftytwo' ),
			'next_text'				=> __( '&raquo;', 'fiftytwo' ),
			'size'					=> 'default',
			'show_disabled'			=> true,
		) );
		$args['type'] = 'array';
...
// Custom Comments Pagination.
if ( ! function_exists( 'fiftytwo_the_comments_pagination' ) ) :
	function fiftytwo_the_comments_pagination( $args = array() ) {
		echo fiftytwo_get_the_comments_pagination( $args );
	}
endif;
...
if ( ! function_exists( 'fiftytwo_menu_fallback' ) ) :
	function fiftytwo_menu_fallback() {
		echo '<div class="alert-box secondary">';
		/* translators: %1$s: link to menus, %2$s: link to customize. */
		printf(
			__( 'Please assign a menu to the primary menu location under %1$s or %2$s the design.', 'fiftytwo' ),
			/* translators: %s: menu url */
			sprintf(
				__( '<a href="%s">Menus</a>', 'fiftytwo' ),
				get_admin_url( get_current_blog_id(), 'nav-menus.php' )
			),
			/* translators: %s: customize url */
			sprintf(
				__( '<a href="%s">Customize</a>', 'fiftytwo' ),
...
if ( ! function_exists( 'fiftytwo_active_nav_class' ) ) :
	function fiftytwo_active_nav_class( $classes, $item ) {
		if ( $item->current == 1 || $item->current_item_ancestor == true ) {
			$classes[] = 'is-active';
		}
		return $classes;
	}
	add_filter( 'nav_menu_css_class', 'fiftytwo_active_nav_class', 10, 2 );
endif;
 ...
 */
if ( ! function_exists( 'fiftytwo_active_list_pages_class' ) ) :
	function fiftytwo_active_list_pages_class( $input ) {
	...
	add_filter( 'wp_list_pages', 'fiftytwo_active_list_pages_class', 10, 2 );
endif;
...
if ( ! function_exists( 'fiftytwo_mobile_menu_id' ) ) :
	function fiftytwo_mobile_menu_id() {
...
if ( ! function_exists( 'fiftytwo_title_bar_responsive_toggle' ) ) :
	function fiftytwo_title_bar_responsive_toggle() {
 ...
 */
if ( ! function_exists( 'fiftytwo_gallery' ) ) :
	function fiftytwo_gallery($attr) {
	...
	add_shortcode('gallery', 'fiftytwo_gallery');
endif;
