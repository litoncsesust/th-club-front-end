...
function fiftytwo_custom_sizes( $sizes ) {
	return array_merge(
		$sizes, array(
...
add_filter( 'image_size_names_choose', 'fiftytwo_custom_sizes' );

// Add custom image sizes attribute to enhance responsive image functionality for content images
function fiftytwo_adjust_image_sizes_attr( $sizes, $size ) {
...
add_filter( 'wp_calculate_image_sizes', 'fiftytwo_adjust_image_sizes_attr', 10, 2 );
