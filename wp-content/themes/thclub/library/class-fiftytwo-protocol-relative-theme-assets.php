 ...
 *
 * @package fiftytwo
 * @since fiftytwo 1.1.0
 */

if ( ! class_exists( 'fiftytwo_Protocol_Relative_Theme_Assets' ) ) :
	class fiftytwo_Protocol_Relative_Theme_Assets {
		/**
	...
	$fiftytwo_protocol_relative_theme_assets = new fiftytwo_Protocol_Relative_Theme_Assets;
endif;
