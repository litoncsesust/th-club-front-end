...
class ApiCLass {
  ...
  public function fetchClubApiData($token, $url, $body, $method = 'get') {  
    $headers = array(
      'Authorization' => $token
    );
  ...
  $subject = "New Order #". $_SESSION['order_id'];
  $headers = "From: clubwebshop@th-club.com";
                                                      ...
                                                      <tr>
                                                        <td style="">
                                                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            <tbody>
                                                              <tr>
                                                                <td class="padding-all" align="right" width="218"  style="text-align: right;color:#3b3937;vertical-align: top; padding: 20px;" valing="top">Ordre nr.: #941532</td>
                                                              </tr>
                                                            </tbody>
                                                          </table>
                                                        </td>
                                                        ...
                                                        <td style="">
                                                          <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                            <tbody>
                                                              <tr>
                                                                <td class="padding-all" align="left" width="510" style="padding: 20px;">
                                                                  <img border="0" alt="' . $sp['title']. '" class="img-max" width="100%" height="300" src="' . $this->baseUrl() . $sp['files'][0]['file_path'] . '" style="display: block;color: #666666; text-decoration: none; width: 465px !important; height:300px !important;padding-bottom:10px;">
                                                                  <h2>' . $sp['title'] . '</h2>
