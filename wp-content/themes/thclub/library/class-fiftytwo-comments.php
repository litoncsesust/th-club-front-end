...
if ( ! class_exists( 'fiftytwo_Comments' ) ) :
	class fiftytwo_Comments extends Walker_Comment {
	 ...
	 * start_lvl() only goes as high as 1 deep nested comments */
		function __construct() { ?>
			...
			<h3><?php comments_number( __( 'No Responses to', 'fiftytwo' ), __( 'One Response to', 'fiftytwo' ), __( '% Responses to', 'fiftytwo' ) ); ?> &#8220;<?php the_title(); ?>&#8221;</h3>
	 ...
	 * Ends the children list of after the elements are added. */
		...
		function start_el( &$output, $comment, $depth = 0, $args = array(), $id = 0 ) {
			...
			<header class="comment-author">
				...
				printf(
					__( '<cite class="fn">%s</cite>', 'fiftytwo' ),
				...
				<section id="comment-content-<?php comment_ID(); ?>" class="comment">
					<?php if ( ! $comment->comment_approved ) : ?>
							<div class="notice">
					<p class="bottom"><?php _e( 'Your comment is awaiting moderation.', 'fiftytwo' ); ?></p>
				</div>
